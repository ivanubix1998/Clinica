...
namespace ClinicaAnimales.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Color,Edad,historialVacuna,IdDueno")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Color,Edad,historialVacuna,IdDueno")] Mascota mascota)
        {
            if (ModelState.IsValid)
            {
